...
1. Clone this repository: `git clone https://github.com/abhinav1karthik/LSTM-Stock-Forecaster`
2. This project uses Yahoo finance library to directly fetch data.
